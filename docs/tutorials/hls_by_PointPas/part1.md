...
> Заметка перенесена на версию Vivado 2023.1 и отладочную плату MicroPhase Z7-Lite
...
![alt_text](part1_assets/fig1.png)
...
![alt_text](part1_assets/fig2.png)
...
![alt_text](part1_assets/fig3.png)
...
![alt_text](part1_assets/fig4.png)

_Рисунок 4 – Выбираем ПЛИС/плату_
...
![alt_text](part1_assets/fig9.png)

_Рисунок 9 – Структурная схема_
...
![alt_text](part1_assets/fig10.png)

_Рисунок 10 – Проводник в Vivado HLS_
...
![alt_text](part1_assets/fig15.png)
...
INFO: [SIM 4] CSIM will launch GCC as the compiler.
   Compiling ../../../../pwm_test.cpp in debug mode
...
![alt_text](part1_assets/fig17.png)
...
![alt_text](part1_assets/fig18.png)

_Рисунок 18 – Выбор директивы для `PWM`_
 
 
![alt_text](part1_assets/fig19.png)

_Рисунок 19 – Выбор директивы для `OutPWM`_
...
![alt_text](part1_assets/fig20.png)

_Рисунок 20 – Выбор функции для синтеза_
...
![alt_text](part1_assets/fig21.png)
...
![alt_text](part1_assets/fig22.png)

Рисунок 22 – Выбор директивы для переменной LoadValCnt

Повторим последнее действие для переменных `Rst` и `EN`. Для выходов применим директиву такую же, как ранее для вывода `OutPWM` (Рисунок 19). Должно получится следующим образом:
...
#pragma HLS INTERFACE mode=ap_none port=EN_r
#pragma HLS INTERFACE mode=ap_none port=Rst_r
#pragma HLS INTERFACE mode=ap_none port=LoadValCnt_r
#pragma HLS INTERFACE mode=s_axilite bundle=CTRL port=EN
#pragma HLS INTERFACE mode=s_axilite bundle=CTRL port=Rst
#pragma HLS INTERFACE mode=s_axilite bundle=CTRL port=LoadValCnt
...
#pragma HLS INTERFACE mode=ap_none port=OutPWM
...
Тем, кто создавал проект первым способом, сейчас необходимо будет добавить новое решение (_Solution_). Для этого вверху на панели инструментов нажимаем кнопку **New Solution** (Рисунок 24). Называем его `PWM_CTRL`.
...
![alt_text](part1_assets/fig25.png)

Рисунок 25 – Выбор активного уровня сброса

![alt_text](part1_assets/fig26.png)
...
![alt_text](part1_assets/fig27.png)
...
![alt_text](part1_assets/fig31.png)
...
![alt_text](part1_assets/fig32.png)
...
1. [Vivado High-Level Synthesis ](https://www.xilinx.com/products/design-tools/vivado/integration/esl-design.html#overview)
2. [Осваиваем Zynq-7000s с бесплатной отладкой](https://www.youtube.com/playlist?list=PLWMg96mLREOekNVh8-3U5JZv2NTCLMbP5)
3. [UG871. Vivado Design Suite Tutorial: High-Level Synthesis](https://www.xilinx.com/support/documentation/sw_manuals/xilinx2019_1/ug871-vivado-high-level-synthesis-tutorial.pdf)
4. [UG902. Vivado Design Suite UserGuide: High-Level Synthesis](https://www.xilinx.com/support/documentation/sw_manuals/xilinx2019_1/ug902-vivado-high-level-synthesis.pdf)
5. [Xilinx Zynq-7000 SoC](https://www.xilinx.com/products/silicon-devices/soc/zynq-7000.html)
6. [Разработка софт-процессорной системы на базе MicroBlaze (цикл статей)](http://archive.fpga-systems.org/publ/xilinx/microblaze/10)
